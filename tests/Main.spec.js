...
// test.beforeEach(`@Smoke Client app login for ${data.ProductName}`, async ({ browser }) => {
//     const context = await browser.newContext();
//     const page = await context.newPage();

//     MainFile = new POmanager(page);
...
// test.afterEach(`@Regression Client app login for ${data.ProductName}`, async ({ browser }) => {
//     const context = await browser.newContext();
//     const page = await context.newPage();
